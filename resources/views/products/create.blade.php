...
<body class="antialiased text-gray-900 min-h-screen relative bg-gray-100">
    ...
    <div class="relative z-10 flex flex-col min-h-screen">
        ...
        <header class="bg-white/90 backdrop-blur-md border-b border-gray-200 sticky top-0 z-50 shadow-sm">
            <div class="max-w-4xl mx-auto px-4 py-3 flex justify-between items-center">
                <a href="{{ url('/') }}" class="flex items-center gap-3 group outline-none" title="Về trang chủ">
                    <div class="w-10 h-10 bg-gradient-to-br from-emerald-400 to-green-600 rounded-xl flex items-center justify-center text-white text-xl shadow-lg shadow-emerald-200/50 transform transition-transform group-hover:scale-110 group-hover:rotate-3">
                ...
                <a href="{{ url('/') }}" class="text-gray-500 hover:text-red-600 font-bold flex items-center gap-2 transition-all bg-white hover:bg-red-50 px-4 py-2 rounded-xl text-sm border border-gray-200 hover:border-red-200 shadow-sm">
        ...
        <main class="max-w-4xl mx-auto px-4 py-8 w-full flex-grow">
            <div class="bg-white rounded-[2rem] shadow-xl border border-gray-100 overflow-hidden">
                ...
                <div class="text-center pt-10 pb-6 px-6">
                    <div class="flex justify-center items-center gap-2 text-sm text-gray-400 font-medium mb-4">
                        <a href="{{ url('/') }}" class="hover:text-emerald-600 transition-colors">Trang chủ</a>
                        <i class="fa-solid fa-angle-right text-[10px]"></i>
                        <a href="{{ route('my.products') }}" class="hover:text-emerald-600 transition-colors">Sản phẩm của tôi</a>
                        <i class="fa-solid fa-angle-right text-[10px]"></i>
                        <span class="text-emerald-600 font-bold">Đăng tin thanh lý</span>
                    </div>
                ...
                {{-- Hiển thị Lỗi (Nếu có) --}}
                @if ($errors->any())
                <div class="mx-6 md:mx-8 mb-6 bg-red-50 border border-red-200 text-red-700 px-6 py-5 rounded-2xl shadow-sm">
                ...
                <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="p-6 md:p-8 space-y-8 bg-gray-50/50 border-t border-gray-100">
                        ...
                        <div>
                            ...
                            <div class="space-y-5">
                                <div>
                                    ...
                                    <input type="text" name="title" value="{{ old('title') }}" required placeholder="Ví dụ: iPhone 13 Pro Max 256GB VN/A Xanh Lá..." class="w-full px-4 py-3 bg-white border border-gray-200 shadow-sm rounded-xl focus:outline-none focus:border-emerald-500 focus:ring-4 focus:ring-emerald-50 transition-all font-medium text-gray-900 placeholder:text-gray-400">
                                </div>

                                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    <div>
                                        <label class="block text-sm font-bold text-gray-700 mb-2">Danh mục <span class="text-red-500">*</span></label>
                                        <select name="category_id" required class="w-full px-4 py-3 bg-white border border-gray-200 shadow-sm rounded-xl focus:outline-none focus:border-emerald-500 focus:ring-4 focus:ring-emerald-50 transition-all font-medium text-gray-900 cursor-pointer">
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            <input type="number" name="condition_pct" min="1" max="100" value="{{ old('condition_pct') }}" required placeholder="Ví dụ: 95" class="w-full px-4 py-3 bg-white border border-gray-200 shadow-sm rounded-xl focus:outline-none focus:border-emerald-500 focus:ring-4 focus:ring-emerald-50 transition-all font-medium text-gray-900">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                <div>
                                    ...
                                    <input type="number" name="price" value="{{ old('price') }}" required placeholder="Ví dụ: 1500000" class="w-full px-4 py-3 bg-white border border-gray-200 shadow-sm rounded-xl focus:outline-none focus:border-emerald-500 focus:ring-4 focus:ring-emerald-50 transition-all font-black text-emerald-600 text-lg tracking-wide">
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" name="location" value="{{ old('location') }}" required placeholder="Địa chỉ cụ thể, quận/huyện..." class="w-full pl-10 pr-4 py-3 bg-white border border-gray-200 shadow-sm rounded-xl focus:outline-none focus:border-emerald-500 focus:ring-4 focus:ring-emerald-50 transition-all font-medium text-gray-900">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="border-2 border-dashed border-gray-300 rounded-2xl bg-white p-5 transition-colors relative hover:border-emerald-400" id="drop-zone">
                                ...
                                <div id="empty-state" class="py-12 flex flex-col items-center justify-center cursor-pointer hover:bg-emerald-50/50 rounded-xl transition-colors">
                                    <div class="w-16 h-16 bg-white shadow-sm border border-emerald-100 rounded-full flex items-center justify-center text-emerald-500 text-2xl mb-3">
                                ...
                                <div id="preview-grid" class="grid grid-cols-2 md:grid-cols-5 gap-4 hidden">
                                    <div id="add-more-btn" class="aspect-square rounded-xl border-2 border-dashed border-gray-300 flex flex-col items-center justify-center text-gray-400 cursor-pointer hover:border-emerald-500 hover:text-emerald-600 hover:bg-emerald-50 transition-colors bg-white shadow-sm">
                        ...
                        <div>
                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <textarea name="description" rows="5" required placeholder="Tình trạng hiện tại, phụ kiện đi kèm, lý do bán, chính sách bảo hành (nếu có)..." class="w-full px-4 py-3 bg-white border border-gray-200 shadow-sm rounded-xl focus:outline-none focus:border-emerald-500 focus:ring-4 focus:ring-emerald-50 transition-all font-medium text-gray-900 leading-relaxed placeholder:text-gray-400">{{ old('description') }}</textarea>
                                </div>

                                <div>
                                    <div class="flex justify-between items-center mb-2">
                                        <label class="block text-sm font-bold text-gray-700">Thông số kỹ thuật</label>
                                        <span class="text-xs text-gray-400 font-bold bg-gray-100 px-2 py-1 rounded-md">Không bắt buộc</span>
                                    </div>
                                    <textarea name="specifications" rows="6" placeholder="Nhập mỗi thông số 1 dòng. Ví dụ:&#10;Màn hình: 6.7 inch&#10;Chip: Snapdragon 8 Gen 2&#10;Dung lượng: 256GB&#10;Pin: 5000 mAh" class="w-full px-4 py-3 bg-white border border-gray-200 shadow-sm rounded-xl focus:outline-none focus:border-emerald-500 focus:ring-4 focus:ring-emerald-50 transition-all font-medium text-gray-900 leading-relaxed placeholder:text-gray-400">{{ old('specifications') }}</textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    {{-- THANH ACTION (ĐÃ ĐỔI MÀU XANH NGỌC) --}}
                    <div class="p-6 md:p-8 bg-white border-t border-gray-100 rounded-b-[2rem]">
                        <button type="submit" class="w-full bg-gradient-to-r from-emerald-500 to-green-600 text-white font-black py-4 rounded-xl hover:from-emerald-600 hover:to-green-700 shadow-lg shadow-emerald-200/50 transform hover:-translate-y-1 transition-all duration-300 text-center flex items-center justify-center gap-3 text-lg uppercase tracking-wider outline-none">
                            <i class="fa-solid fa-paper-plane"></i> Đăng tin thanh lý ngay
                        </button>
                        <p class="text-center text-xs text-gray-500 font-medium mt-5">
                            Bằng việc đăng tin, bạn đồng ý với <a href="#" class="text-emerald-600 font-bold hover:underline">Quy định bán hàng</a> của 2HAND.
                        </p>
                    </div>
                </form>
            </div>
    ...
    {{-- SCRIPTS XỬ LÝ ẢNH (ĐÃ FIX LỖI ẢNH BÌA) --}}
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function renderPreviews() {
                ...
                selectedFiles.forEach((file, index) => {
                    ...
                    wrapper.className = `thumb-wrapper relative aspect-square rounded-xl overflow-hidden shadow-sm cursor-pointer group border-2 transition-all ${isCover ? 'border-emerald-500 ring-4 ring-emerald-50' : 'border-gray-200 hover:border-gray-300'}`;
                    
                    // Gắn sự kiện thiết lập ảnh bìa
                    wrapper.onclick = function() { setCover(index); }
                    ...
                    wrapper.innerHTML = `
                        ...
                        <div class="overlay absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity items-center justify-center ${isCover ? 'hidden' : 'flex'}">
                            <span class="text-white text-[10px] font-bold uppercase tracking-wider border border-white px-2 py-1 rounded shadow pointer-events-none">Chọn làm bìa</span>
                        </div>
                        <button type="button" class="absolute top-2 right-2 w-7 h-7 bg-red-500 text-white rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all transform hover:scale-110 hover:bg-red-600 shadow-md">
            ...
            // ĐÃ SỬA: Hàm setCover kích hoạt vẽ lại UI để đồng bộ state hoàn hảo
            function setCover(index) {
                coverIndexInput.value = index.toString();
                renderPreviews(); // Xóa và vẽ lại lưới ảnh (tránh lỗi DOM)
            }
        });
    </script>
</body>
