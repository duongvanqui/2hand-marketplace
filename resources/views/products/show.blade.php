...
<head>
    ...
    <style>
        /* Ẩn thanh cuộn cho danh sách ảnh thu nhỏ */
...
<body class="bg-gray-50 font-sans text-gray-900 flex flex-col min-h-screen">
    ...
    {{-- ĐÃ BỔ SUNG CLASS cart-counter VÀO THẺ SPAN BÊN DƯỚI --}}
                ...
                <div class="flex items-center border-l pl-5 ml-2">
                    ...
                    <div class="relative group py-2">
                        <div class="flex items-center gap-3 cursor-pointer">
                            {{-- Sửa lỗi hiển thị Avatar cho User đang đăng nhập --}}
                            @if(Auth::user()->avatar)
    ...
    <main class="max-w-6xl mx-auto px-4 pb-12 flex-grow w-full">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 bg-white p-6 md:p-8 rounded-2xl shadow-sm border border-gray-100">
            ...
            {{-- 1. CỘT TRÁI: ẢNH SẢN PHẨM (Chiếm 5 phần) --}}
            ...
            {{-- 2. CỘT PHẢI: THÔNG TIN SẢN PHẨM & NGƯỜI BÁN (Chiếm 7 phần) --}}
            <div class="lg:col-span-7 flex flex-col">
                ...
                {{-- THẺ NGƯỜI BÁN (Sửa lỗi hiển thị avatar người bán) --}}
                ...
                <div class="flex gap-4 mt-8 mt-auto">
                    ...
                    <a href="#" class="px-6 py-3.5 border-2 border-green-600 text-green-700 font-bold rounded-xl hover:bg-green-50 transition-all flex items-center gap-2">
        ...
        {{-- 3. KHỐI BẢNG THÔNG SỐ KỸ THUẬT (Tách dòng tự động) --}}
        ...
        $(document).ready(function() {
            $('.ajax-add-to-cart').on('submit', function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: url,
                    data: form.serialize(), // Gửi token CSRF đi kèm
                    success: function(response) {
                        if (response.success) {
                            // Hiện thông báo (Bạn có thể dùng thư viện Toastr cho đẹp hơn)
                            alert(response.message);
                            // Cập nhật con số trên Navbar
